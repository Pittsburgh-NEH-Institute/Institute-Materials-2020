...
This announcement has been posted to [Humanist](http://dhhumanist.org/), [Digital Classicist](http://www.digitalclassicist.org/), [Digital Medievalist](https://digitalmedievalist.wordpress.com/), [TEI-L](https://tei-c.org/support/#tei-l), [Scholarly Editing](http://www2004.lsoft.se/scripts/wl.exe?SL1=sedit-l&H=listserv.umd.edu), [WWP-Encoding](https://listserv.neu.edu/cgi-bin/wa?A0=wwp-encoding), the Society for the History of Authorship, Reading, and Publishing ([SHARP-L](mailto:sharp-l@list.indiana.edu)), the DiXiT Fellows mailing list, and the <https:digitalhumanities.slack.com> channel. Please circulate.